...
namespace MyGameCPU {
    const int128_t TIMEOUT = (int128_t)1<<100;
    ...
    class ZemanntruBot {
        ...
        private:
            ...
            int128_t negaScout(int128_t player, int128_t opponent, bool bRoot, bool clear, int depth, int128_t alpha, int128_t beta);
